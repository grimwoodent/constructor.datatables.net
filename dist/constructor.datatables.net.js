/*!
 * ConstructorDatatablesNet.js v1.0.2
 * https://github.com/grimwoodent/constructor.datatables.net#readme
 *
 * Copyright 2018 GrimwoodEnt
 * Released under the MIT license
 *
 * Date: 2018-05-21T15:07:37.532Z
 */

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
  typeof define === 'function' && define.amd ? define(['exports'], factory) :
  (factory((global.ConstructorDatatablesNet = {})));
  ...
  var grim_lib_common = createCommonjsModule(function (module, exports) {
  ...
  unwrapExports(grim_lib_common);
  var grim_lib_common_1 = grim_lib_common.Define;
  var grim_lib_common_2 = grim_lib_common.Callbacks;
  var grim_lib_common_3 = grim_lib_common.Cookie;
  var grim_lib_common_4 = grim_lib_common.UID;
  var grim_lib_common_5 = grim_lib_common.Collection;
  ...
  (function( $, window, document, undefined ) {
  	...
  	_Api.extend = function ( scope, obj, ext )
  	{
  		...
  		var 
  			i, ien,
  			struct, methodScoping = function ( scope, fn, struc ) {
  				return function () {
  ...
  (function( factory ){
  	if ( typeof undefined === 'function' && undefined.amd ) {
  		// AMD
  		undefined( ['jquery', 'datatables.net-bs', 'datatables.net-buttons'], function ( $ ) {
  			return factory( $, window, document );
  		} );
  	}
  	else {
  ...
  * cells: a `_selected_cells` property which contains an array of boolean values
  ...
  (function( factory ){
  	if ( typeof undefined === 'function' && undefined.amd ) {
  		// AMD
  		undefined( ['jquery', 'datatables.net', 'datatables.net-buttons'], function ( $ ) {
  			return factory( $, window, document );
  		} );
  	}
  	else {
  ...
  var ColumnVisibleButton =
  /*#__PURE__*/
  function (_Button) {
    function ColumnVisibleButton(manager) {
      var _this;

      _classCallCheck(this, ColumnVisibleButton);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(ColumnVisibleButton).call(this, manager));
      _this.columns = [];
      return _this;
    }

    _createClass(ColumnVisibleButton, [{
      key: "setColumns",
    ...
    _inherits(ColumnVisibleButton, _Button);

    return ColumnVisibleButton;
  }(Button);
  ...
  function () {
    ...
    _createClass(Toolbar, [{
      ...
      value: function getElement() {
        ...
        if (!this.isControl()) {
          var element = $$2(this.getTemplate());
    ...
    _createClass(Header, [{
      ...
      value: function apply() {
        ...
        Object.keys(this.headerData).forEach(function (idx) {
          ...
          if (data.className) {
            $$3(element).addClass(data.className);
          }
        });
        return this.table;
      }
  ...
  function () {
    function DomConstructor() {
      ...
      this.positions = {};
      var defaultsVars = $$4.fn.dataTable.defaults;
  ...
  function () {
    ...
    _createClass(TableSorting, [{
      ...
      value: function add() {
        ...
        $$5.extend($$5.fn.dataTableExt.oSort, (_$$extend = {}, _defineProperty(_$$extend, "".concat(this.settings.name, "-pre"), this.settings.pre), _defineProperty(_$$extend, "".concat(this.settings.name, "-asc"), this.settings.asc), _defineProperty(_$$extend, "".concat(this.settings.name, "-desc"), this.settings.desc), _$$extend));
      }
    }], [{
      key: "create",
  ...
  // const $ = require('jquery');
  var $$6 = jQuery;
  var BaseDataTable = $$6.fn.dataTable; // disable alerts
  ...
  var DataTableSorting = TableSorting;
  var EVENT = EVENTS;
  var ORDER$1 = ORDER;
  var LANG = CONSTANT_LANG_RU;
  var DataTable =
  /*#__PURE__*/
  function () {
    ...
    _createClass(DataTable, [{
      ...
      value: function init() {
        ...
        grim_lib_common_1.property(this, 'api', api).readonly().var();
        this.toolbars.replaceAllIn(this.api.table().container());
        this.header.apply();
        grim_lib_common_1.property(this, 'inited', true).readonly().var();
        return this;
      }
    }, {
      key: "destroy",
      ...
      get: function get() {
        ...
        return grim_lib_common_1.property(this, 'toolbars', instance).var();
      }
      /**
      ...
      get: function get() {
        ...
        return grim_lib_common_1.property(this, 'buttons', instance).var();
      }
      /**
       * Header info storage
       *
      ...
      get: function get() {
        ...
        return grim_lib_common_1.property(this, 'header', instance).var();
      }
    }, {
      key: "toolbar",
      get: function get() {
  ...
  exports.DataTableSorting = DataTableSorting;
  exports.EVENT = EVENT;
